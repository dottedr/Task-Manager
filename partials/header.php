    ...
    <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse navbar-responsive-collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="tasks.php"><i class="fa fa-square-o"></i>&nbsp; View Remaining Tasks</a></li>
                <li><a href="completedTasks.php"><i class="fa fa-check-square-o"></i>&nbsp; View Completed Tasks</a></li>                
            </ul>
        </div>
    </div>
</div>
